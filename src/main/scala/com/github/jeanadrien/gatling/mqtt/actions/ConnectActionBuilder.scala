...
/**
  *
  */
case class ConnectActionBuilder(connectionSettings: ConnectionSettings = ConnectionSettings(
    ...
    def willMessage(willMessage: Expression[String]) = this.modify(_.connectionSettings.willMessage).setTo(Some(willMessage))
